...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2021 a las 03:13:09
...
INSERT INTO `tbl_clientes` (`ID_CLIENTE`, `NOMBRE`, `CORREO_ELECTRONICO`, `CLAVE`) VALUES
...
INSERT INTO `tbl_cupones` (`ID_CUPON`, `CODIGO`, `ID_CLIENTE`) VALUES
(1, '68185AP', 1),
(2, '5897984BG', 3),
(3, '789416VF', 4),
(4, '569781NJ', 5),
...
--
ALTER TABLE `tbl_carrito`
  ADD CONSTRAINT `FK_CARRITO_CLIENTE` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `tbl_clientes` (`ID_CLIENTE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tbl_cupones`
  ADD CONSTRAINT `FK_CLIENTE_CUPONES` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `tbl_clientes` (`ID_CLIENTE`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tbl_pedido`
--
ALTER TABLE `tbl_pedido`
  ADD CONSTRAINT `FK_CLIENTE_PEDIDO` FOREIGN KEY (`ID_CLIENTE`) REFERENCES `tbl_clientes` (`ID_CLIENTE`) ON DELETE CASCADE ON UPDATE CASCADE,
