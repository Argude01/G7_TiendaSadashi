...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2021 a las 19:08:04
...
(1, 'CARLOS890@GMAIL.COM', '12345', 0),
(2, 'PAOLAMARTINEZ@GMAIL.COM', '6789', 56),
(7, 'PAOLAMARTINEZ@GMAIL.COM', '6789', 56);
...
INSERT INTO `tbl_cupones` (`ID_CUPON`, `ID_NOMBRE`, `ID_CLIENTE`) VALUES
(1, 2, 1),
(2, 2, 1);
...
(3, 94991958, 'deposito', 450, 'calle ssantiago', 1, 2),
(4, 94991958, 'deposito', 450, 'calle ssantiago', 1, 2),
(5, 97107412, 'TRANSFERENCIA', 1200, 'CALLE 504', 7, 3),
(6, 97107412, 'TRANSFERENCIA', 1200, 'CALLE 504', 7, 3);
...
INSERT INTO `tbl_productos` (`ID_PRODUCTO`, `PROUCTO`, `TALLA`, `PRECIO`, `ID_CATEGORIA`) VALUES
(1, 'camisa', 's', 120, 1),
(2, 'camisa', 's', 120, 1),
(3, 'PANTALON', 'M', 650, 1),
(5, 'PANTALON', 'M', 650, 1);
